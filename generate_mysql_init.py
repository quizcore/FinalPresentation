...
STUDENTS: list[Student] = [
    ...
    Student(
        ...
        first_name="Lucas",
        last_name="Hernandez",
        dob=datetime.datetime(2000, 10, 17),
        taken_date=datetime.datetime(2022, 4, 5),
        email="lucas.hernandez@mail.com",
        expected_term="Fall2024",
        prev_education=None,
        prev_classes=None,
        cs110=cs110_all_wrong([2, 4, 6, 7]),
        cs111=[],
    ),
    Student(
        sid=None,
        first_name="Zachary",
        last_name="Carter",
        dob=datetime.datetime(2003, 1, 28),
        taken_date=datetime.datetime(2021, 12, 28),
        email="zachary.carter@mail.com",
        expected_term="Fall2022",
        prev_education=None,
        prev_classes=None,
        cs110=cs110_all_wrong([5, 6, 7, 8]),
        cs111=[],
    ),
    Student(
        sid="15847522",
        ...
        last_name="Lee",
        dob=datetime.datetime(2001, 7, 18),
        taken_date=datetime.datetime(2024, 2, 1),
        email="alexander.lee@mail.com",
        expected_term="Fall2025",
        prev_education=None,
        prev_classes=None,
        cs110=cs110_all_correct([1, 8, 9, 10]),
        cs111=cs111_all_wrong([2, 4, 5, 10]),
    ),
    Student(
        sid=None,
        first_name="Noah",
        last_name="Mitchell",
        dob=datetime.datetime(1995, 8, 28),
        taken_date=datetime.datetime(2023, 1, 9),
        email="noah.mitchell@mail.com",
        expected_term="Fall2024",
        prev_education="Highline",
        prev_classes="CS100, CS110",
        cs110=cs110_all_correct([8, 10, 11]),
        cs111=cs111_all_wrong([1, 2, 4, 8]),
    ),
    Student(
        sid="15847584",
        first_name="Mia",
        last_name="Stewart",
        dob=datetime.datetime(2005, 2, 15),
        taken_date=datetime.datetime(2024, 1, 4),
        email="mia.stewart@mail.com",
        expected_term="Fall2025",
        prev_education=None,
        prev_classes=None,
        cs110=cs110_all_wrong([7, 8, 9, 10, 11]),
        cs111=[],
    ),
    Student(
        sid=None,
        first_name="Emma",
        last_name="Taylor",
        dob=datetime.datetime(2004, 2, 19),
        taken_date=datetime.datetime(2024, 5, 1),
        email="emma.taylor@mail.com",
        expected_term="Fall2024",
        prev_education=None,
        prev_classes=None,
        cs110=cs110_all_wrong([2, 3, 4, 10, 11, 12]),
        cs111=[],
    ),
    Student(
        sid=None,
        first_name="Harper",
        last_name="Lee",
        dob=datetime.datetime(1999, 6, 16),
        taken_date=datetime.datetime(2023, 4, 1),
        email="harper.lee@mail.com",
        expected_term="Spring2024",
        prev_education=None,
        prev_classes=None,
        cs110=cs110_all_correct([2]),
        cs111=cs111_all_wrong([4, 5, 6, 9, 10, 11]),
    ),
    Student(
        sid=None,
        first_name="Sam",
        last_name="Ross",
        dob=datetime.datetime(2002, 12, 31),
        taken_date=datetime.datetime(2024, 4, 4),
        email="sam.ross@mail.com",
        expected_term="Fall2024",
        prev_education="WSU",
        prev_classes="CS110",
        cs110=cs110_all_wrong([8, 9, 13]),
        cs111=[],
    ),
    Student(
        sid=None,
        first_name="Isaac",
        last_name="Martinez",
        dob=datetime.datetime(2004, 2, 10),
        taken_date=datetime.datetime(2023, 11, 12),
        email="isaac.martinez@mail.com",
        expected_term="Winter2025",
        prev_education="Seattle U",
        prev_classes="CS110",
        cs110=cs110_all_correct([1, 2, 4, 5, 6, 7, 8]),
        cs111=[],
    ),
]
